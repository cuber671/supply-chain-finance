package com.fisco.app.contract.enterprise;
...
public class EnterpriseRegistryAuth extends Contract {
    ...
    public static EnterpriseRegistryAuth load(String contractAddress, Client client,
            CryptoKeyPair credential) {
        return new EnterpriseRegistryAuth(contractAddress, client, credential);
    }

    public static EnterpriseRegistryAuth deploy(Client client, CryptoKeyPair credential) throws
            ContractException {
        return deploy(EnterpriseRegistryAuth.class, client, credential, getBinary(client.getCryptoSuite()), getABI(), null, null);
    }
}
