    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests(auth -> auth
                ...
                .antMatchers("/api/v1/auth/login", "/api/v1/auth/admin/login", "/api/v1/auth/refresh", "/api/v1/auth/validate", "/api/v1/auth/users/register", "/api/v1/auth/enterprise/token").permitAll()
                // 用户管理接口需要认证
